...
export declare const zh: {
    ...
    'board.hostError.notMounted': string;
    'board.hostError.unauthorized': string;
    'board.hostError.locked': string;
    ...
    'board.projectNewPath': string;
    'board.projectNewPathPlaceholder': string;
    'board.projectCreate': string;
    'board.projectCreateFailed': string;
    'new.aiParse': string;
    'new.aiParseHint': string;
    'new.aiParsePlaceholder': string;
    'new.aiParseModel': string;
    'new.aiParseRun': string;
    'new.aiParseCancel': string;
    'new.aiParseEmpty': string;
    'new.aiParseNoModel': string;
    'new.aiParseUnavailable': string;
    'new.aiParseTimeout': string;
    'new.aiParseFailed': string;
    ...
    'new.required': string;
    'new.freeze': string;
    'new.freezePlaceholder': string;
    'detail.freeze': string;
    'detail.freeze.goal': string;
    'detail.freeze.progress': string;
    'detail.freeze.next': string;
    'detail.freeze.frozenAt': string;
    ...
    'detail.handover.bundledAt': string;
    'detail.handover.references': string;
    'new.tags': string;
    'new.tagsHint': string;
    'new.tagName': string;
    'new.tagNamePlaceholder': string;
    'new.tagPrompt': string;
    'new.tagPromptPlaceholder': string;
    'new.tagAdd': string;
    ...
    'detail.permissionConfirmed': string;
    'detail.title': string;
    'detail.edit': string;
    'detail.editTags': string;
    'detail.duplicate': string;
    'detail.duplicateAndEdit': string;
    'detail.close': string;
    'edit.title': string;
    'edit.save': string;
    ...
    'detail.execution.initiator': string;
    ...
    'exec.model.unknown': string;
    'exec.reuseSession': string;
    'exec.reuseSessionHint': string;
...
export declare function setRuntimeTranslate(t: ((key: TaskBoardKey, params?: Record<string, string>) => string) | undefined): void;

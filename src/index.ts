// dsh-file-bookmark — file/folder bookmark plugin with 3 core tools.
//
// Tools (see src/tools/ for per-feature implementation):
//   1. bookmark-add   — add a file or folder to bookmarks.
//   2. bookmark-open  — open a bookmarked item in the system file manager.
//   3. project-create — create a project from a template.
//
